...
# NOT WORKING - TAKES TOO MUCH TIME - SOMETHING IS NOT TUNED RIGHT
...
# scale the data - as per normalization guidelines
...
downscale_scaled = scaler.transform(downscale)
dfHD['t2mHD'] = best_model.predict(downscale_scaled)
