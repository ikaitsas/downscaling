...
print('Formatting Low Resolution Data...')
...
#dsLD.to_netcdf('dsLD.nc')

print('Done.\n')


#%% enswmatwsh DEM gia to HD - 2024
print('Formatting High Resolution Data...')
...
#to RandomForestRegressor exei box-shaped artefacts
#panta gia to idio setup, pou akolouthei
model2 = ExtraTreesRegressor(n_estimators=50, random_state=42, 
                             max_features=2, n_jobs=-1
                             ) 
model2.fit(X_train, y_train)

#joblib.dump(model2, 'mhxanaki2ET.pkl')

fueatures_in_model = model2.feature_names_in_
feature_importances = model2.feature_importances_

print(f'Model Used: {type(model2).__name__}')
...
print('Executing High Resolution Data Fitting...')
...
dfHD.to_parquet('dfHD_fitted.parquet')
dsHD2.to_netcdf('dsHD_fitted.nc')
...
plt.xlabel('Longitude')
plt.ylabel('Latitude')
#plt.savefig('0_KATI_KANAME22ET.png', dpi=300)
plt.show()
